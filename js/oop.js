...
*/
function Hamburger(bun, garnishes, cheeses, sauces, patties, pattyCount, extras) {
    this.bun = bun;
    ...
    this.describe = function() {
        let description = "Delicious hamburger with: ";
        description += this.pattyCount > 1 ? `${this.pattyCount} ${this.patties} patties, ` : `a ${this.patties} patty, `;
        description += `${this.bun}, ${this.garnishes.join(', ')}, `;
        description += `${this.cheeses.join(', ')} cheese, `;
