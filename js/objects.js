...
let person ={
    ...
    address:{
        steetNo: 100,
        steetName:"heart stone",
        City: "Barrie"
    },
    interests:["painting","swimming","coding"],
    greeting: function(){
        alert('Hello, ${this.name.fistName}  ${this["Name"]["lastName"]}How are you?');
    },
    bio: function(){
        return 'The interest of ${this.name.firstName},of age ${this.age}, of gender ${this.gender}
        are $';
...
person.goodbye = function(){
    alert('This is ${this.name.firstName')
}
